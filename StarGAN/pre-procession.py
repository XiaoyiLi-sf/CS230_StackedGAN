# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 09:57:46 2019
...
photo_dir = "L:\\StackedGAN\\StarGAN\\rafdb\\"
out_dir = "L:\\StackedGAN\\StarGAN\\data\\RaFDB\\"
...
for i in range(file_name.shape[0]):
    ...
    jpgfile.save(out_dir + file_name.Category[i] +"\\"+ file_name.emo[i]+"\\" + file_name.Name[i], 'JPEG')