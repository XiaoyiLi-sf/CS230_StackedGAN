...
def main(config):
    ...
    # Data loader.
    rafdb_loader = get_loader(config.rafdb_image_dir, config.rafdb_crop_size, config.image_size, config.batch_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rafdb_crop_size', type=int, default=100, help='crop size for the RaFDB dataset')
    ...
    # Directories.
    parser.add_argument('--rafdb_image_dir', type=str, default='data/RaFDB/train')
    ...
    parser.add_argument('--result_dir', type=str, default='stargan_rafdb/results')
